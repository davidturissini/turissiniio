...
});define('controller/home/index', ['resource/fetch','q','underscore'], function (resourceFetch,Q,_) {
...
});define('controller/posts/show', ['resource/fetch','model/Photo'], function (resourceFetch,Photo) {
...
});define('flickr/helper/fetchPhoto', ['jQuery'], function (jQuery) {
...
});define('flickr/helper/fetchPhotoSet', ['jQuery'], function (jQuery) {
...
});define('flickr/helper/fetchPhotoSetList', ['jQuery'], function (jQuery) {
...
});define('interactive/home/index', ['jQuery','flickr/helper/fetchPhoto'], function (jQuery,fetchPhoto) {
...
});define('model/Photo', ['backbone','model/FlickrImage'], function (Backbone,FlickrImage) {
